    ...
    <div id="wrapper">
        <div id="page" class="container">
            @error('title')
                {{ $title }}
            @enderror
            <form class="mx-auto max-w-2xl mt-8" action="{{ route('article.update', ['article' => $article->id]) }}') }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="excerpt" id="excerpt" rows="4" required
                        ...
                        placeholder="Maqoladan parcha"> {{ $article->excerpt }}</textarea>
                </div>
                <div class="mb-4">
                    <label for="body"
                    ...
                    <textarea name="body" id="body" rows="4" required
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Maqoladan parcha">   {{ $article->body }}</textarea>
                </div>
                <div class="mb-4">
